...
function Public.on_built_rocket_silo(event)
    ...
    --if prototype.fixed_recipe ~= "rocket-part" then return end
    if prototype.fixed_recipe ~= nil then return end
    ...
    if recipe == "_other" or recipe == nil then return end --If planet excluded from planetlib script, do nothing, let other planet mod handle rocket part recipe assignment.
